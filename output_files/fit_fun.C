...
void fit_fun() {
  auto f = TFile::Open("NPip_02_04_2020.root", "READ");
// //Npip
...
E_vs_theta_e_elastic_events->SetStats(0);
 E_vs_theta_e_elastic_events->DrawCopy("Col");
 E_vs_theta_e_2nd_rsonance_region ->DrawCopy("same col");
 E_vs_theta_e_3rd_rsonance_region ->DrawClone("same col");
}
