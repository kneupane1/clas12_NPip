...
void Branches12::init() {
  ...
  _tree->SetBranchAddress("type", &_type, &b_type);
  _tree->SetBranchAddress("mode", &_mode, &b_mode);
  _tree->SetBranchAddress("torus", &_torus, &b_torus);
  _tree->SetBranchAddress("solenoid", &_solenoid, &b_solenoid);
  _tree->SetBranchAddress("category", &_category, &b_category);
  _tree->SetBranchAddress("topology", &_topology, &b_topology);
  ...
  _tree->SetBranchAddress("RFTime", &_RFTime, &b_RFTime);
  _tree->SetBranchAddress("helicity", &_helicity, &b_helicity);
  _tree->SetBranchAddress("helicityRaw", &_helicityRaw, &b_helicityRaw);
  _tree->SetBranchAddress("procTime", &_procTime, &b_procTime);
  _tree->SetBranchAddress("hel_run", &_hel_run, &b_hel_run);
  _tree->SetBranchAddress("hel_event", &_hel_event, &b_hel_event);
  _tree->SetBranchAddress("hel_timestamp", &_hel_timestamp, &b_hel_timestamp);
  _tree->SetBranchAddress("hel_helicity", &_hel_helicity, &b_hel_helicity);
  _tree->SetBranchAddress("hel_helicityRaw", &_hel_helicityRaw, &b_hel_helicityRaw);
  _tree->SetBranchAddress("hel_pair", &_hel_pair, &b_hel_pair);
  _tree->SetBranchAddress("hel_pattern", &_hel_pattern, &b_hel_pattern);
  _tree->SetBranchAddress("hel_status", &_hel_status, &b_hel_status);
  ...
  _tree->SetBranchAddress("fmt_x", &_fmt_x, &b_fmt_x);
  _tree->SetBranchAddress("fmt_y", &_fmt_y, &b_fmt_y);
  _tree->SetBranchAddress("fmt_z", &_fmt_z, &b_fmt_z);
  ...
  _tree->SetBranchAddress("ec_pcal_du", &_ec_pcal_du, &b_ec_pcal_du);
  _tree->SetBranchAddress("ec_pcal_dv", &_ec_pcal_dv, &b_ec_pcal_dv);
  _tree->SetBranchAddress("ec_pcal_dw", &_ec_pcal_dw, &b_ec_pcal_dw);
  _tree->SetBranchAddress("ec_pcal_m2u", &_ec_pcal_m2u, &b_ec_pcal_m2u);
  _tree->SetBranchAddress("ec_pcal_m2v", &_ec_pcal_m2v, &b_ec_pcal_m2v);
  _tree->SetBranchAddress("ec_pcal_m2w", &_ec_pcal_m2w, &b_ec_pcal_m2w);
  _tree->SetBranchAddress("ec_pcal_m3u", &_ec_pcal_m3u, &b_ec_pcal_m3u);
  _tree->SetBranchAddress("ec_pcal_m3v", &_ec_pcal_m3v, &b_ec_pcal_m3v);
  _tree->SetBranchAddress("ec_pcal_m3w", &_ec_pcal_m3w, &b_ec_pcal_m3w);
  ...
  _tree->SetBranchAddress("ec_ecin_du", &_ec_ecin_du, &b_ec_ecin_du);
  _tree->SetBranchAddress("ec_ecin_dv", &_ec_ecin_dv, &b_ec_ecin_dv);
  _tree->SetBranchAddress("ec_ecin_dw", &_ec_ecin_dw, &b_ec_ecin_dw);
  _tree->SetBranchAddress("ec_ecin_m2u", &_ec_ecin_m2u, &b_ec_ecin_m2u);
  _tree->SetBranchAddress("ec_ecin_m2v", &_ec_ecin_m2v, &b_ec_ecin_m2v);
  _tree->SetBranchAddress("ec_ecin_m2w", &_ec_ecin_m2w, &b_ec_ecin_m2w);
  _tree->SetBranchAddress("ec_ecin_m3u", &_ec_ecin_m3u, &b_ec_ecin_m3u);
  _tree->SetBranchAddress("ec_ecin_m3v", &_ec_ecin_m3v, &b_ec_ecin_m3v);
  _tree->SetBranchAddress("ec_ecin_m3w", &_ec_ecin_m3w, &b_ec_ecin_m3w);
  ...
  _tree->SetBranchAddress("ec_ecout_du", &_ec_ecout_du, &b_ec_ecout_du);
  _tree->SetBranchAddress("ec_ecout_dv", &_ec_ecout_dv, &b_ec_ecout_dv);
  _tree->SetBranchAddress("ec_ecout_dw", &_ec_ecout_dw, &b_ec_ecout_dw);
  _tree->SetBranchAddress("ec_ecout_m2u", &_ec_ecout_m2u, &b_ec_ecout_m2u);
  _tree->SetBranchAddress("ec_ecout_m2v", &_ec_ecout_m2v, &b_ec_ecout_m2v);
  _tree->SetBranchAddress("ec_ecout_m2w", &_ec_ecout_m2w, &b_ec_ecout_m2w);
  _tree->SetBranchAddress("ec_ecout_m3u", &_ec_ecout_m3u, &b_ec_ecout_m3u);
  ...
  _tree->SetBranchAddress("cc_ltcc_phi", &_cc_ltcc_phi, &b_cc_ltcc_phi);
  ...
  _tree->SetBranchAddress("cc_htcc_phi", &_cc_htcc_phi, &b_cc_htcc_phi);
  _tree->SetBranchAddress("cc_htcc_x", &_cc_htcc_x, &b_cc_htcc_x);
  _tree->SetBranchAddress("cc_htcc_y", &_cc_htcc_y, &b_cc_htcc_y);
  _tree->SetBranchAddress("cc_htcc_z", &_cc_htcc_z, &b_cc_htcc_z);
  _tree->SetBranchAddress("cc_rich_sec", &_cc_rich_sec, &b_cc_rich_sec);
  _tree->SetBranchAddress("cc_rich_nphe", &_cc_rich_nphe, &b_cc_rich_nphe);
  _tree->SetBranchAddress("cc_rich_time", &_cc_rich_time, &b_cc_rich_time);
  _tree->SetBranchAddress("cc_rich_path", &_cc_rich_path, &b_cc_rich_path);
  _tree->SetBranchAddress("cc_rich_theta", &_cc_rich_theta, &b_cc_rich_theta);
  _tree->SetBranchAddress("cc_rich_phi", &_cc_rich_phi, &b_cc_rich_phi);
  _tree->SetBranchAddress("cc_rich_x", &_cc_rich_x, &b_cc_rich_x);
  _tree->SetBranchAddress("cc_rich_y", &_cc_rich_y, &b_cc_rich_y);
  _tree->SetBranchAddress("cc_rich_z", &_cc_rich_z, &b_cc_rich_z);
  ...
  _tree->SetBranchAddress("sc_ftof_1a_energy", &_sc_ftof_1a_energy, &b_sc_ftof_1a_energy);
  _tree->SetBranchAddress("sc_ftof_1a_component", &_sc_ftof_1a_component, &b_sc_ftof_1a_component);
  _tree->SetBranchAddress("sc_ftof_1a_x", &_sc_ftof_1a_x, &b_sc_ftof_1a_x);
  _tree->SetBranchAddress("sc_ftof_1a_y", &_sc_ftof_1a_y, &b_sc_ftof_1a_y);
  _tree->SetBranchAddress("sc_ftof_1a_z", &_sc_ftof_1a_z, &b_sc_ftof_1a_z);
  _tree->SetBranchAddress("sc_ftof_1a_hx", &_sc_ftof_1a_hx, &b_sc_ftof_1a_hx);
  _tree->SetBranchAddress("sc_ftof_1a_hy", &_sc_ftof_1a_hy, &b_sc_ftof_1a_hy);
  _tree->SetBranchAddress("sc_ftof_1a_hz", &_sc_ftof_1a_hz, &b_sc_ftof_1a_hz);
  ...
  _tree->SetBranchAddress("sc_ftof_1b_energy", &_sc_ftof_1b_energy, &b_sc_ftof_1b_energy);
  _tree->SetBranchAddress("sc_ftof_1b_component", &_sc_ftof_1b_component, &b_sc_ftof_1b_component);
  _tree->SetBranchAddress("sc_ftof_1b_x", &_sc_ftof_1b_x, &b_sc_ftof_1b_x);
  _tree->SetBranchAddress("sc_ftof_1b_y", &_sc_ftof_1b_y, &b_sc_ftof_1b_y);
  _tree->SetBranchAddress("sc_ftof_1b_z", &_sc_ftof_1b_z, &b_sc_ftof_1b_z);
  _tree->SetBranchAddress("sc_ftof_1b_hx", &_sc_ftof_1b_hx, &b_sc_ftof_1b_hx);
  _tree->SetBranchAddress("sc_ftof_1b_hy", &_sc_ftof_1b_hy, &b_sc_ftof_1b_hy);
  _tree->SetBranchAddress("sc_ftof_1b_hz", &_sc_ftof_1b_hz, &b_sc_ftof_1b_hz);
  ...
  _tree->SetBranchAddress("sc_ftof_2_energy", &_sc_ftof_2_energy, &b_sc_ftof_2_energy);
  _tree->SetBranchAddress("sc_ftof_2_component", &_sc_ftof_2_component, &b_sc_ftof_2_component);
  _tree->SetBranchAddress("sc_ftof_2_x", &_sc_ftof_2_x, &b_sc_ftof_2_x);
  _tree->SetBranchAddress("sc_ftof_2_y", &_sc_ftof_2_y, &b_sc_ftof_2_y);
  _tree->SetBranchAddress("sc_ftof_2_z", &_sc_ftof_2_z, &b_sc_ftof_2_z);
  _tree->SetBranchAddress("sc_ftof_2_hx", &_sc_ftof_2_hx, &b_sc_ftof_2_hx);
  _tree->SetBranchAddress("sc_ftof_2_hy", &_sc_ftof_2_hy, &b_sc_ftof_2_hy);
  ...
  _tree->SetBranchAddress("sc_cnd_z", &_sc_cnd_z, &b_sc_cnd_z);
  ...
  _tree->SetBranchAddress("ft_cal_path", &_ft_cal_path, &b_ft_cal_path);
  _tree->SetBranchAddress("ft_cal_x", &_ft_cal_x, &b_ft_cal_x);
  _tree->SetBranchAddress("ft_cal_y", &_ft_cal_y, &b_ft_cal_y);
  _tree->SetBranchAddress("ft_cal_z", &_ft_cal_z, &b_ft_cal_z);
  _tree->SetBranchAddress("ft_cal_dx", &_ft_cal_dx, &b_ft_cal_dx);
  _tree->SetBranchAddress("ft_cal_dy", &_ft_cal_dy, &b_ft_cal_dy);
  _tree->SetBranchAddress("ft_cal_radius", &_ft_cal_radius, &b_ft_cal_radius);
  _tree->SetBranchAddress("ft_hodo_energy", &_ft_hodo_energy, &b_ft_hodo_energy);
  _tree->SetBranchAddress("ft_hodo_time", &_ft_hodo_time, &b_ft_hodo_time);
  _tree->SetBranchAddress("ft_hodo_path", &_ft_hodo_path, &b_ft_hodo_path);
  _tree->SetBranchAddress("ft_hodo_x", &_ft_hodo_x, &b_ft_hodo_x);
  _tree->SetBranchAddress("ft_hodo_y", &_ft_hodo_y, &b_ft_hodo_y);
  _tree->SetBranchAddress("ft_hodo_z", &_ft_hodo_z, &b_ft_hodo_z);
  _tree->SetBranchAddress("ft_hodo_dx", &_ft_hodo_dx, &b_ft_hodo_dx);
  _tree->SetBranchAddress("ft_hodo_dy", &_ft_hodo_dy, &b_ft_hodo_dy);
  _tree->SetBranchAddress("ft_hodo_radius", &_ft_hodo_radius, &b_ft_hodo_radius);
}
